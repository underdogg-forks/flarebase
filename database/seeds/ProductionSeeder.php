...
class ProductionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $routeDashboard->save();
        $routeUserProfile = Route::where('name', 'staff.profile')->get()->first();
        $routeUserProfile->permission()->associate($permBasicAuthenticated);
        $routeUserProfile->save();
        $routeUserProfilePatch = Route::where('name', 'staff.profile.patch')->get()->first();
        ...
        $manageUserRoutes = Route::where('name', 'like', "admin.staff.%")->get()->all();
        ...
        $roleAuditViewers = Role::create([
            ...
            "description"   => "Staff allowed to view the audit log.",
            "enabled"       => true
        ]);
        ...
        $roleAuditReplayers = Role::create([
            ...
            "description"   => "Staff allowed to replay items from the audit log.",
            "enabled"       => true
        ]);
        ...
        $roleAuditPurgers = Role::create([
            ...
            "description"   => "Staff allowed to purge old items from the audit log.",
            "enabled"       => true
        ]);
        ...
        $roleErrorViewers = Role::create([
            ...
            "description"   => "Staff allowed to view the error log.",
            "enabled"       => true
        ]);
        ...
        $roleErrorPurgers = Role::create([
            ...
            "description"   => "Staff allowed to purge old items from the error log.",
            "enabled"       => true
        ]);
