...
@section('content')
    ...
    <div class='row'>
        <div class='col-md-12'>
            <!-- Box -->
            {!! Form::open( array('route' => 'admin.staff.enable-selected', 'id' => 'frmUserList') ) !!}
                ...
                <div class="box-header with-border">
                    ...
                    &nbsp;
                    <a class="btn btn-default btn-sm" href="#" onclick="document.forms['frmUserList'].action = '{!! route('admin.staff.enable-selected') !!}';  document.forms['frmUserList'].submit(); return false;" title="{{ trans('general.button.enable') }}">
                        <i class="fa fa-check-circle-o"></i>
                    </a>
                    &nbsp;
                    <a class="btn btn-default btn-sm" href="#" onclick="document.forms['frmUserList'].action = '{!! route('admin.staff.disable-selected') !!}';  document.forms['frmUserList'].submit(); return false;" title="{{ trans('general.button.disable') }}">
                        <i class="fa fa-ban"></i>
                    </a>
                                    ...
                                    <tr>
                                        <td align="center">
                                            @if ($staffmember->canBeDisabled())
                                                {!! Form::checkbox('chkUser[]', $staffmember->id); !!}
                                            @endif
                                        </td>
                                        <td><img src="{{ Gravatar::get($staffmember->email , 'tiny') }}" class="user-image" alt="User Image"/></td>
